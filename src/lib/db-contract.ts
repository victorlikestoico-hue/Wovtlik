...
ALTER TABLE outbox ADD COLUMN IF NOT EXISTS broadcast_batch_id TEXT DEFAULT NULL;
ALTER TABLE group_failure_reports ADD COLUMN IF NOT EXISTS tl_reacted_at TIMESTAMP WITH TIME ZONE DEFAULT NULL;
