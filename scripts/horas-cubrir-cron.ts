...
function buildPrompt(entries: HoraCubrirEntry[]): string {
	...
	return [
		...
		"El tono tiene que sonar MUY colombiano pero corto: 1-2 expresiones típicas como máximo (ej. \"parcero\", \"qué chimba\", \"de una\", \"bacano\"), sin exagerar ni sonar forzado ni alargar el mensaje.",
		"Vendé el plan en UNA sola frase corta aprovechando que son agentes de home office (sin salir de casa, sin transporte). No te extiendas en esto.",
